...
serve(async (req: Request) => {
  ...
  try {
    ...
    try {
      ...
      const _p1Year = new Date().getFullYear();
      const _p1RecentYears = [_p1Year - 1, _p1Year, _p1Year + 1, _p1Year + 2]
        .filter((y) => y >= 2020)
        .join(", ");
