...
Seller's note: "${voiceNote}"`;
    ...
    const descriptionSchemaProperties = {
      description: {
        type: "string",
        description:
          'Write a natural, human-sounding eBay description in plain text. Do NOT use markdown, HTML, or section headers.\n\nSTRUCTURE:\n\n1. OPENING PARAGRAPH: Start with what the item is and its basic appeal. Keep it straightforward and accessible.\n\n2. PHYSICAL DESCRIPTION (1-2 paragraphs): Describe condition, handling marks, wear, what\'s included or missing. Be honest about the state and what the photos show.\n\n3. HISTORICAL NOTE or WHY IT\'S COOL (1-2 paragraphs): Explain the item\'s history, rarity, significance, or what makes it collectible. This should feel authentic and engaging, not generic marketing language.\n\n4. QUICK SPECS: Introduce specs with a line "Quick Specs:" then provide key details as \'Label: Value\' lines (e.g., "Brand: Valcambi", "Metal: .9999 Fine Gold").\n\n5. CLOSING: Brief note about photo quality and an AI disclosure (e.g., "Listing generated by ListrAssistr. All details should be verified by the buyer.").\n\nCRITICAL FORMATTING: Separate EVERY section and every paragraph with ONE BLANK LINE. Never hard-wrap a sentence across two lines. The converter reads blank lines to build proper formatting — without them, everything becomes one wall of text.',
      },
    };
