...
- **Structure**: Use ## Section headers. Keep paragraphs short (1-2 sentences). Use bulleted "Quick Specs".

## Opening Hook
Lead with the most compelling reason to own this coin or bullion piece. Use a direct, conversational opener that sounds like a human seller.
...
## Opening Hook
Lead with the most compelling reason to own this coin or bullion piece. Use a direct, conversational opener that sounds like a human seller, not AI marketing copy. Avoid clichés like "Discover..." or "Elevate your collection."
Good: "Up for sale is a striking 1 Troy Ounce .999 fine copper bullion bar. If you’re looking for an affordable way to add some weight to your collection while showing off some American pride, this colorized flag bar is a fantastic choice."
...
## What's Included / Quick Specs
Summarize the key facts clearly. For many items, a bulleted list of "Quick Specs" works best for readability.
- Weight: [e.g. "1 Troy Ounce (AVDP)"]
- Metal: [e.g. ".999 Fine Copper"]
- Design: [e.g. "Colorized Waving American Flag"]
- Condition: [e.g. "Uncirculated (Bar is new; capsule shows minor storage wear)"]
...
## Why Buy This Item
Explain the appeal in a natural, knowledgeable way. Cover rarity, historical significance, or practical value. Mention the obverse/reverse details if they are noteworthy.
Example: "The obverse features a highly detailed, vibrant waving American flag design that covers the entire face of the bar. The reverse is cleanly stamped with the weight and purity: '1 Troy Ounce .999 Copper.' Combining that heritage with the modern waving flag design creates a powerful tribute to the U.S.A." (2–4 sentences)
...
- **FINAL OUTPUT FORMAT (OVERRIDES ANY SECTION TEMPLATE ABOVE)**:
- Write in plain text like a real human seller.
- Do NOT include scaffold labels like "Opening Hook", "What Sets It Apart", "Closing Statement", "Overview", or "Specifications".
- Preferred flow: short opening paragraph (2-4 sentences), then a "Quick Specs:" block with one fact per line, then a brief trust-building closing paragraph.
- Keep tone conversational, direct, and sales-oriented without sounding scripted.
- **NATURAL TONE**: Write like a human seller on a message board. Use "You're looking at...", "Up for sale is...", "If you're looking for...". Use contractions naturally.
- **HISTORICAL GROUNDING**: If the item has historical significance (e.g. Gadsden flag, specific Mint history, patriotic motifs), explain WHY it matters.
- **CONDITION HONESTY**: Mention visible wear or storage marks (e.g., "capsule shows minor scuffing")—it builds trust.
- **NO AI SLOP**: Strictly avoid "Discover", "Elevate", "Showcases", "Features exceptional", "Whether you're a seasoned collector or...", "In the realm of", "Delve into".
- **PROFESSIONAL TONE**: No emojis, no em-dashes (—). Use plain hyphens (-) or commas.
- **TITLE SEO** - Front-load: Year, Denomination/Type, Mint Mark, Metal Content, Weight, Key Feature, Condition.
`;
}
