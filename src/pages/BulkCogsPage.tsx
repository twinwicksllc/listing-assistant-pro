...
export default function BulkCogsPage() {
  ...
  function exportCogs(onlyMissing = true) {
    const toExport = onlyMissing
      ? rows.filter((r) => r.savedCogs == null)
      : rows;
    ...
    toast.success(
      `Exported ${count} listing${count > 1 ? "s" : ""} (${activeCount} active, ${soldCount} sold) — fill in the "cogs" column and re-upload.`,
    );
  }
        ...
        <div className="max-w-4xl mx-auto px-4 py-4 space-y-4 border-b border-border/50">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/50 rounded-lg p-3">
            ...
            <p className="text-xs text-blue-800 dark:text-blue-300 mb-3">
              Click <strong>"Missing Only"</strong> to download items without
              costs, or <strong>"Download All"</strong> to get a template of all
              listings.
            </p>
            <ul className="text-xs text-blue-700 dark:text-blue-400 space-y-1">
              <li>✓ Open the CSV in Excel, Google Sheets, or Numbers</li>
              <li>
                ✓ Fill in the <strong>"cogs"</strong> column with your item
                costs
              </li>
              <li>
                ✓ <strong>Do NOT</strong> change column headers (sku,
                ebay_listing_id, title, price, status, cogs)
              </li>
              <li>
                ✓ <strong>Do NOT</strong> add, remove, or reorder columns
              </li>
              <li>
                ✓ <strong>Do NOT</strong> add or delete rows unless you know
                what you're doing
              </li>
            ...
            <div className="mt-4 pt-4 border-t border-border/50 space-y-3">
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 rounded-lg p-3">
                <p className="text-xs text-amber-800 dark:text-amber-300">
                  <strong>Important:</strong> The CSV file you upload must have
                  the same format and column headers as when you downloaded it.
                  Any changes to columns, headers, or row order will cause the
                  import to fail.
                </p>
              </div>
    ...
    >
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-1.5">
          {row.status === "SOLD" && (
            <span className="shrink-0 text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400">
              Sold
            </span>
          )}
