...
const STEPS = [
  {
    num: "01",
    title: "Upload Photos",
    desc: "Take photos or upload images of your item. Add a voice note for additional context if needed.",
  },
  {
    num: "02",
    title: "Review the Analysis",
    desc: "The system identifies the item, researches current market pricing, and generates a complete eBay listing in seconds.",
  },
  {
    num: "03",
    title: "Publish to eBay",
    desc: "Approve the listing as-is or make quick edits, then push directly to eBay as a draft — ready to go live.",
  },
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-20 px-5 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse, rgba(0,118,182,0.10) 0%, transparent 70%)",
            }}
          />
          <div
            className="absolute top-24 right-0 w-[300px] h-[300px] rounded-full blur-3xl"
            style={{
              background:
                "radial-gradient(ellipse, rgba(176,183,188,0.12) 0%, transparent 70%)",
            }}
          />
        </div>
        ...
        <div className="relative max-w-2xl mx-auto text-center space-y-6">
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
            Upload photos of any resellable item. Get a complete,
            market-researched eBay listing — title, description, category, item
            specifics, and competitive pricing — ready to publish.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <button
              ...
              style={{
                ...
                boxShadow:
                  "0 4px 20px rgba(0,118,182,0.30), 0 2px 6px rgba(0,0,0,0.15)",
              }}
            >
          ...
          <div className="flex items-center justify-center gap-1 pt-1">
            ...
            <span className="text-xs text-muted-foreground ml-2">
              Trusted by resellers, dealers & collectors
            </span>
          </div>
        </div>
        ...
        <div className="relative max-w-sm mx-auto mt-12">
          <div
            ...
            style={{
              boxShadow:
                "0 8px 40px rgba(0,0,0,0.12), 0 2px 8px rgba(0,118,182,0.10)",
            }}
          >
            {/* Fake browser bar */}
            <div
            ...
            <div className="p-4 space-y-3">
              ...
              >
                <p className="text-xs font-semibold text-foreground leading-snug">
                  1921-D Morgan Silver Dollar MS-63 Lustrous Mint State — US
                  Coin
                </p>
                <p className="text-xs text-muted-foreground">
                  eBay Category: US Coins › Dollars › Morgan (1878–1921)
                </p>
              </div>
              ...
              >
                ...
                <p className="text-xs text-emerald-700 font-medium">
                  Melt value: $27.84 · Price protected ✓
                </p>
              </div>
              <button
      ...
      <section
        ref={statsRef}
        className="py-14 px-5 border-y border-border"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">
              Every feature is designed around one goal: getting accurate,
              competitive listings live faster than doing it by hand.
            </p>
          </div>
      ...
      {/* ── HOW IT WORKS ── */}
      <section
        className="py-20 px-5 border-y border-border"
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-sm text-muted-foreground">
              Three steps from item in hand to listing on eBay.
            </p>
          </div>
          <div className="space-y-6">
            {STEPS.map((step, i) => (
              <div key={step.num} className="flex items-start gap-5">
                ...
                {i < STEPS.length - 1 && (
                  <div
                    className="absolute left-[2.35rem] mt-14 w-px h-6 bg-border"
                    style={{
                      position: "relative",
                      marginLeft: "-3.85rem",
                      marginTop: "3.5rem",
      ...
      {/* ── CTA BANNER ── */}
      <section
        className="py-16 px-5 border-t border-border"
        style={{
          background:
            "linear-gradient(135deg, rgba(0,118,182,0.07) 0%, rgba(176,183,188,0.08) 50%, rgba(0,0,0,0.02) 100%)",
        }}
      >
        <div className="max-w-xl mx-auto text-center space-y-5">
          ...
          <p className="text-sm text-muted-foreground">
            Join resellers and dealers who are turning items into live eBay
            listings in under a minute.
          </p>
          <button
            onClick={() => navigate("/signup")}
            ...
            style={{
              backgroundColor: "#0076B6",
              boxShadow:
                "0 4px 20px rgba(0,118,182,0.30), 0 2px 6px rgba(0,0,0,0.12)",
            }}
          >
            Get Started Free
