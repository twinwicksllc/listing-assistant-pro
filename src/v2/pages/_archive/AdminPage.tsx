          ...
          <>
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {data.stripe.error ||
                          `Mode: ${data.stripe.mode.toUpperCase()}`}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {formatTokensInMillions(data.gemini.totalTokens ?? 0)}{" "}
                        tokens (30d)
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-card border border-border rounded-xl p-4 space-y-1">
                ...
                <p className="text-2xl font-bold text-foreground">
                  ${(data.gemini.estimatedCost ?? 0).toFixed(4)}
                </p>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              <div className="divide-y divide-border">
                {[
                  {
                    label: "Analyze (AI)",
                    count: data.featureUsage.ai_analysis,
                    icon: "🔍",
                  },
                  {
                    label: "Optimize",
                    count: data.featureUsage.optimize,
                    icon: "✨",
                  },
                  {
                    label: "Publish",
                    count: data.featureUsage.ebay_publish,
                    icon: "📤",
                  },
                  {
                    label: "Export",
                    count: data.featureUsage.export,
                    icon: "💾",
                  },
                ].map((item) => (
                  <div
            ...
            {/* Gemini Usage Chart */}
            {data.gemini?.last30Days &&
              Array.isArray(data.gemini.last30Days) &&
            ...
            {data.gemini?.last30DaysCost &&
              Array.isArray(data.gemini.last30DaysCost) &&
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-card border border-border rounded-xl p-4 space-y-1">
                ...
                <p className="text-2xl font-bold text-foreground">
                  {formatTokensInMillions(data.gemini.inputTokens ?? 0)}
                </p>
                <p className="text-[10px] text-muted-foreground">
                  ${((data.gemini.inputTokens ?? 0) * 0.00000125).toFixed(4)}
                </p>
              </div>
              ...
              <div className="bg-card border border-border rounded-xl p-4 space-y-1">
                ...
                <p className="text-2xl font-bold text-foreground">
                  {formatTokensInMillions(data.gemini.outputTokens ?? 0)}
                </p>
                <p className="text-[10px] text-muted-foreground">
                  ${((data.gemini.outputTokens ?? 0) * 0.000005).toFixed(4)}
                </p>
              </div>
              ...
              <div className="bg-card border border-border rounded-xl p-4 space-y-1">
                ...
                <p className="text-2xl font-bold text-foreground">
                  ${data.gemini.estimatedCost.toFixed(4)}
                </p>
                <p className="text-[10px] text-muted-foreground">
                  30-day total
                </p>
                            ...
                            >
                              ...
                              <td className="px-4 py-2 text-right font-semibold text-foreground">
                                ...
                                <div className="text-[10px] text-muted-foreground">
                                  {(
                                    (stats.cost / data.gemini.estimatedCost) *
                                    100
                                  ).toFixed(1)}
                                  %
                                </div>
