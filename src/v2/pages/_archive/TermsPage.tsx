    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground [&_h2]:text-foreground [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mt-8 [&_h2]:mb-3">
          ...
          <p>By accessing or using the Sovereign Listing Suite platform ("Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>

          <h2>2. Description of Service</h2>
          <p>Sovereign Listing Suite provides AI-powered tools for identifying, cataloging, and listing items for resale on third-party marketplaces such as eBay. The Service includes image analysis, pricing suggestions, draft management, and listing publication features.</p>
          ...
          <p>All payments are processed securely through Stripe, Inc. By subscribing to a paid plan, you authorize Sovereign Listing Suite to charge your payment method via Stripe. We do not store your full credit card number on our servers. All payment data is handled in accordance with PCI-DSS standards. Subscription fees are billed in advance on a monthly basis and are non-refundable except as required by law. You may cancel your subscription at any time through the billing portal.</p>

          <h2>5. eBay Integration &amp; Data Usage</h2>
          <p>The Service integrates with the eBay API to publish listings and retrieve pricing data. By connecting your eBay account, you grant Sovereign Listing Suite permission to: (a) create, modify, and manage listings on your behalf; (b) access sold item data for pricing analysis; (c) store your eBay API tokens securely. Your use of eBay through our Service remains subject to eBay's own User Agreement and policies. Sovereign Listing Suite is not responsible for actions taken by eBay on your account.</p>
          ...
          <p>You retain ownership of all photos, descriptions, and other content you upload. By uploading content, you grant Sovereign Listing Suite a limited, non-exclusive license to process, store, and transmit that content solely for the purpose of providing the Service.</p>
          ...
          <p>To the maximum extent permitted by law, Sovereign Listing Suite shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service, including but not limited to loss of profits, data, or business opportunities.</p>
          ...
          <h2>11. Contact</h2>
          <p>For questions about these Terms, contact us at <span className="text-primary">legal@twinwicksds.com</span>.</p>
        </div>
      </div>
      <LegalFooter />
    </div>
