...
const S = {
  ...
  tabList: {
    ...
    overflow: "hidden",
    boxShadow:
      "0 4px 6px -1px rgba(0,0,0,0.07), 0 10px 30px -5px rgba(0,80,140,0.10)",
  } as React.CSSProperties,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: "1.0625rem", fontWeight: 700, color: "#141820" }}
        >
          {name}
        </span>
      </div>
...
export default function SettingsPage2() {
  ...
  const handleDisconnectEbay = async () => {
    try {
      const { data, error } =
        await supabase.functions.invoke("disconnect-ebay");
      if (error || !data?.success) {
        throw new Error(
          data?.error || error?.message || "Failed to disconnect eBay account",
        );
      }
    } catch (err: any) {
  ...
  const ProfileTab = (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,80,140,0.12)";
          e.currentTarget.style.transform = "translateY(-1px)";
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,80,140,0.06)";
          e.currentTarget.style.transform = "translateY(0)";
        }}
      >
        <div style={S.rowBtnInner}>
          <span style={S.rowBtnLabel}>Edit Profile</span>
          <span style={S.rowBtnSub}>
      ...
      {isAdmin && (
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.boxShadow = "0 4px 16px rgba(217,119,6,0.14)";
            e.currentTarget.style.transform = "translateY(-1px)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.boxShadow = "0 2px 8px rgba(217,119,6,0.08)";
            e.currentTarget.style.transform = "translateY(0)";
          }}
        >
          <div style={S.rowBtnInner}>
          ...
          <ChevronRight
            size={18}
            style={{ ...S.rowBtnArrow, color: "#d97706" }}
          />
        </button>
      )}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div style={S.card}>
        <div style={S.cardHeader}>
          ...
          <p style={{ ...S.cardSubtitle, marginTop: "0.25rem" }}>
            {planDisplayName}
          </p>
        </div>
  ...
  const IntegrationsTab = (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      <div>
        ...
        <p style={S.sectionSub}>
          Connect third-party platforms to expand your selling capabilities.
        </p>
      </div>
          ...
          {!ebayConnected ? (
            ...
            >
              <p style={{ fontSize: "0.9375rem", color: "#6E7580" }}>
                Authorize Sovereign Listing Suite to access your eBay account.
