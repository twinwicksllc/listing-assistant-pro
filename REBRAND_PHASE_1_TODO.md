...
| O-37 | **Confirm the four facts about `yqftpibxplachhwoclam`** — exists, region, empty, project URL. This determines whether qa is configuration (in scope) or needs a Phase 3 gate (A.9a)                                                                                                                                                                                                                                                                                                                                                                                                            | —          | **P1**   |
| O-38 | **Confirm which Supabase project ref you checked for SMTP**, and which project `listrassistr-official` is wired to today, if any (A.10)                                                                                                                                                                                                                                                                                                                                                                                                                                                        | —          | **P1**   |
