...
| -------- | --------------------------------------------------------------------------------------------------- | ---------------------------------- | ---------------------------------------------- | --------- | ------------------------------------------------------------------------- |
| RBR-0001 | Target Supabase project ref is `wcednzaxmxwfiijzmjmx`, but shared/legacy ownership is unverified    | High: wrong-project migration risk | `supabase/config.toml`                         | User + AI | Open; verify project dashboard and ownership                              |
